...
const BlockchainPropulsionToken = artifacts.require('BlockchainPropulsionToken');

contract("BlockchainPropulsion Token Test", async accounts => {
    ...
    it("Name should be equals to `TestToken`", async () => {
        let instance = await BlockchainPropulsionToken.deployed();
